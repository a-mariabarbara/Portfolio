        ...
        <div className="relative p-4 text-center">
            ...
            <div className="absolute left-1/2 top-3 z-0 h-10 w-10 rounded-lg bg-blue-100/40" />
                ...
                <div className="relative mx-auto mt-20 max-w-lg">
                  ...
                  <div className="absolute -left-2 -top-4 h-24 w-20 rounded-lg bg-gray-600 bg-[url(../Imagens/IMG_0100.jpg)] bg-cover bg-center md:-left-12 md:-top-12 md:h-72 md:w-56"></div>
