...
export  function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 83 9.8605-4261",
      link: "https://wa.me/5583986054261?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "barbaramariac25@gmail.com",
      link: "mailto:barbaramariac25@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "João Pessoa, PB",
      description: "Mangabeira IV",
      link: "https://maps.app.goo.gl/TpgHYU6ArZwWeSkM8",
      ...
      <div className="container mx-auto max-w-4xl p-4 py-8">
        <div className="mb-6">
          <h2 className="z-50 mb-2">
            ...
            <span className="font-handwriting text-4xl text-pink-300">Comigo</span>
          </h2>
          <p className="text-sm">
